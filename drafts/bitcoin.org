...
I was listening to an episode of Radiolab about cryptocurrencies the
other day, and I realized that while I had a general understanding of
how Bitcoin and other cryptocoins work I couldn't explain the specific
algorithms involved. This is exactly the sort of thing RC is great for
learning, so I decided to spend a couple days reading up on Bitcoin
and trying to implement a simple cryptocurrency of my own.

My first stop was the [[https://bitcoin.org/bitcoin.pdf][Bitcoin whitepaper]], the original research paper
that introduced the idea for Bitcoin, published by the figure known as
Satoshi Nakamoto on a cryptography mailing list in October
of 2008. Despite my having only a casual knowledge of cryptography, I
found the paper to be clear and elegant. Of course, I as soon as I sat
down to implement some of the most important ideas from the paper I
realized that I hadn't understood it as well as I thought, but by
going back and forth between the code and the paper and discussing it
with fellow Recursers I think I understand the basics well enough to
try to explain them in a blog post.
...
"block" in the chain -- a group of valid transactions to be added to
...
putting in enough work to find the blocks, and meanwhile, the real
blockchain will continue to grow. That means, as long as no one person
controls more than half of the computers in the network,[fn:half] the longest
blockchain will be the valid one, and forgeries of past blocks won't
be practical. All an individual node has to do in order to support the
"real" blockchain is to work on the search for the next block for that
chain -- there's no voting or explicit consensus mechanism needed.
