...
Elm.Main.make = function (_elm) {
   ...
   var renderThrust = function (_p0) {
      var _p1 = _p0;
      var _p2 = _p1.accelerating;
      if (_p2 === true) {
            return $Maybe.Just($Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,
                                                               $Color.orange,
                                                               $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: -10,_1: 5}
                                                                                                 ,{ctor: "_Tuple2",_0: -18,_1: 0}
                                                                                                 ,{ctor: "_Tuple2",_0: -10,_1: -5}])))
                                                               ,A2($Graphics$Collage.filled,
                                                               $Color.yellow,
                                                               $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: -10,_1: 5}
                                                                                                 ,{ctor: "_Tuple2",_0: -15,_1: 0}
                                                                                                 ,{ctor: "_Tuple2",_0: -10,_1: -5}])))
                                                               ,A2($Graphics$Collage.filled,
                                                               $Color.lightBlue,
                                                               $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: -10,_1: 5}
                                                                                                 ,{ctor: "_Tuple2",_0: -13,_1: 0}
                                                                                                 ,{ctor: "_Tuple2",_0: -10,_1: -5}])))])));
         } else {
            return $Maybe.Nothing;
         }
   };
   var renderShip = function (_p3) {
      var _p4 = _p3;
      var ship = A2($Graphics$Collage.filled,
      $Color.white,
      $Graphics$Collage.polygon(_U.list([{ctor: "_Tuple2",_0: -10,_1: -10},{ctor: "_Tuple2",_0: 15,_1: 0},{ctor: "_Tuple2",_0: -10,_1: 10}])));
      var shipWithThrust = function () {
         var _p5 = renderThrust(_p4);
         if (_p5.ctor === "Just") {
               return $Graphics$Collage.group(_U.list([ship,_p5._0]));
            } else {
               return ship;
            }
      }();
      return A2($Graphics$Collage.rotate,_p4.facing,A2($Graphics$Collage.move,_p4.location,shipWithThrust));
   };
   var renderAsteroid = function (asteroid) {
      var size = function () {    var _p6 = asteroid.size;switch (_p6.ctor) {case "Small": return 7;case "Medium": return 14;default: return 20;}}();
      return A2($Graphics$Collage.move,
      asteroid.location,
      A2($Graphics$Collage.outlined,$Graphics$Collage.solid($Color.white),A2($Graphics$Collage.ngon,5,size)));
   };
   var renderBullets = function (bullets) {
      return A2($List.map,
      function (b) {
         return A2($Graphics$Collage.move,b.location,A2($Graphics$Collage.filled,$Color.white,$Graphics$Collage.circle(3)));
      },
      bullets);
   };
   var rotateAsteroidCourse = F2(function (rotation,_p7) {
      var _p8 = _p7;
      var _p9 = _p8.velocity;
      var speed = _p9._0;
      var angle = _p9._1;
      var newAngle = angle + rotation;
      return _U.update(_p8,{velocity: {ctor: "_Tuple2",_0: speed,_1: newAngle}});
   });
   var near = F3(function (radius,_p11,_p10) {
      var _p12 = _p11;
      var _p13 = _p10;
      return _U.cmp($Basics.sqrt(Math.pow(_p12._0 - _p13._0,2) + Math.pow(_p12._1 - _p13._1,2)),radius) < 0;
   });
   var playerHasCollided = function (_p14) {
      var _p15 = _p14;
      return A2($List.any,function (a) {    return A3(near,20,_p15.player.location,a.location);},_p15.asteroids);
   };
   var objectShouldBeRemoved = F2(function (targets,object) {
      return A2($List.any,function (target) {    return A3(near,20,object.location,target.location);},targets);
   });
   var addVelocities = F2(function (v1,v2) {
      var _p16 = A2($Debug.log,"x2, y2",$Basics.fromPolar(v2));
      var x2 = _p16._0;
      var y2 = _p16._1;
      var _p17 = A2($Debug.log,"x1, y1",$Basics.fromPolar(v1));
      var x1 = _p17._0;
      var y1 = _p17._1;
      return $Basics.toPolar({ctor: "_Tuple2",_0: x1 + x2,_1: y1 + y2});
   });
   var wrapScalar = F2(function (x,max) {    return _U.cmp(x,max) > 0 ? 0 - max : _U.cmp(x,0 - max) < 0 ? max : x;});
   var Input = F4(function (a,b,c,d) {    return {delta: a,pauseKey: b,fireKey: c,arrows: d};});
   var input = A2($Signal.sampleOn,delta,A5($Signal.map4,Input,delta,$Keyboard.enter,$Keyboard.space,$Keyboard.arrows));
   var timeSeed = function (t) {    return function (_p18) {    return $Random.initialSeed($Basics.round(_p18));}(t);};
   var asteroid = F3(function (randLoc,randV,randSize) {    return {location: randLoc,velocity: randV,size: randSize};});
   var randomVelocity = A2($Random.pair,A2($Random.$float,-200,200),A2($Random.map,$Basics.degrees,A2($Random.$float,0,360)));
   var bulletSpeed = 300;
   var newBullet = function (_p19) {
      var _p20 = _p19;
      var _p21 = _p20.player;
      return {location: _p21.location,velocity: {ctor: "_Tuple2",_0: bulletSpeed,_1: _p21.facing},ttl: 1.5};
   };
   var addBulletIfNeeded = F2(function (input,_p22) {
      var _p23 = _p22;
      var _p24 = _p23;
      var decrementCooldown = function (player) {    return _U.cmp(player.cooldown,0) > 0 ? _U.update(player,{cooldown: player.cooldown - 1}) : player;};
      var cooldown = _p24.player.cooldown;
      return _U.eq(input.fireKey,true) && _U.eq(cooldown,0) ? _U.update(_p24,
      {bullets: A2($List._op["::"],newBullet(_p24),_p24.bullets),player: _U.update(_p23.player,{cooldown: 5})}) : _U.update(_p24,
      {player: decrementCooldown(_p24.player)});
   });
   var accelerationCoefficient = 40;
   var rotationSpeed = -0.3;
   var Game = F4(function (a,b,c,d) {    return {state: a,player: b,asteroids: c,bullets: d};});
   var Large = {ctor: "Large"};
   var Medium = {ctor: "Medium"};
   var Small = {ctor: "Small"};
   var randomSize = A2($Random.map,
   function (i) {
      var _p25 = i;
      switch (_p25)
      {case 1: return Small;
   ...
   A2($Random.$int,1,3));
   var fragmentAsteroid = function (a) {
      var childAsteroids = function (newSize) {
         return _U.list([A2(rotateAsteroidCourse,-15,_U.update(a,{size: newSize})),A2(rotateAsteroidCourse,1,_U.update(a,{size: newSize}))]);
      };
      var _p26 = a.size;
      switch (_p26.ctor)
      {case "Small": return _U.list([]);
         case "Medium": return childAsteroids(Small);
         default: return childAsteroids(Medium);}
   };
   var fragmentShotAsteroids = function (game) {
      var uncollidedAsteroids = A2($List.filter,function (_p27) {    return $Basics.not(A2(objectShouldBeRemoved,game.bullets,_p27));},game.asteroids);
      var collidedAsteroids = A2($List.filter,objectShouldBeRemoved(game.bullets),game.asteroids);
      return _U.update(game,
      {asteroids: A2($Basics._op["++"],uncollidedAsteroids,A2($List.concatMap,fragmentAsteroid,collidedAsteroids))
      ,bullets: A2($List.filter,function (_p28) {    return $Basics.not(A2(objectShouldBeRemoved,game.asteroids,_p28));},game.bullets)});
   };
   var _p29 = {ctor: "_Tuple2",_0: 600,_1: 600};
   var gameWidth = _p29._0;
   var gameHeight = _p29._1;
   var _p30 = {ctor: "_Tuple2",_0: gameWidth / 2,_1: gameHeight / 2};
   var halfWidth = _p30._0;
   var halfHeight = _p30._1;
   var randomCoordinate = A2($Random.pair,A2($Random.$float,0 - halfWidth,halfWidth),A2($Random.$float,0 - halfHeight,halfHeight));
   var randomAsteroid = A4($Random.map3,asteroid,randomCoordinate,randomVelocity,randomSize);
   var randomAsteroids = function (seed) {    var _p31 = A2($Random.generate,A2($Random.list,5,randomAsteroid),seed);var result = _p31._0;return result;};
   var physicsUpdate = F2(function (t,_p32) {
      var _p33 = _p32;
      var _p34 = _p33.velocity;
      var r = _p34._0;
      var theta = _p34._1;
      var _p35 = {ctor: "_Tuple2",_0: r * $Basics.sin(theta),_1: r * $Basics.cos(theta)};
      var dy = _p35._0;
      var dx = _p35._1;
      var _p36 = _p33.location;
      var x = _p36._0;
      var y = _p36._1;
      var dt = t;
      var newX = x + dt * dx;
      var newY = y + dt * dy;
      return _U.update(_p33,{location: {ctor: "_Tuple2",_0: A2(wrapScalar,newX,halfWidth),_1: A2(wrapScalar,newY,halfHeight)}});
   });
   var updatePlayer = F2(function (_p38,_p37) {
      var _p39 = _p38;
      var _p43 = _p39.delta;
      var _p42 = _p39.arrows;
      var _p40 = _p37;
      var _p41 = _p40.player;
      var accelerating = _U.eq(_p42.y,1) ? true : false;
      var newFacing = _p41.facing + rotationSpeed * $Basics.toFloat(_p42.x);
      var deltaV = {ctor: "_Tuple2",_0: _p43 * accelerationCoefficient,_1: newFacing};
      var setNewFields = function (player) {
         return _U.update(player,
         {facing: newFacing,velocity: accelerating ? A2(addVelocities,player.velocity,deltaV) : player.velocity,accelerating: accelerating});
      };
      return _U.update(_p40,{player: A2(physicsUpdate,_p43,setNewFields(_p41))});
   });
   var updateAsteroids = F2(function (delta,game) {
      return fragmentShotAsteroids(_U.update(game,{asteroids: A2($List.map,physicsUpdate(delta),game.asteroids)}));
   });
   var updateBullets = F2(function (delta,game) {
      var decrementTtl = function (bullet) {    return _U.update(bullet,{ttl: bullet.ttl - delta});};
      return _U.update(game,
      {bullets: A2($List.filter,
      function (bullet) {
         return _U.cmp(bullet.ttl,0) > 0;
      },
      $List.map(function (_p44) {    return decrementTtl(A2(physicsUpdate,delta,_p44));})(game.bullets))});
   });
   var Over = {ctor: "Over"};
   var updateState = function (game) {    return _U.update(game,{state: playerHasCollided(game) ? Over : game.state});};
   var Pause = {ctor: "Pause"};
   var Play = {ctor: "Play"};
   var view = F2(function (_p45,game) {
      var _p46 = _p45;
      var state = A2(txt,$Basics.identity,_U.eq(game.state,Play) ? "" : _U.eq(game.state,Pause) ? "Paused (ENTER to start)" : "Game Over");
      ...
      _U.list([A2($Graphics$Collage.filled,$Color.black,A2($Graphics$Collage.rect,gameWidth,gameHeight))
              ...
              ,$Graphics$Collage.group(A2($List.map,renderAsteroid,game.asteroids))
              ,$Graphics$Collage.group(renderBullets(game.bullets))])));
   });
   var Start = {ctor: "Start"};
   var newGame = {state: Start
                 ,player: {location: {ctor: "_Tuple2",_0: 0,_1: 0},facing: 0,accelerating: false,velocity: {ctor: "_Tuple2",_0: 0,_1: 0},cooldown: 0}
                 ,asteroids: _U.list([])
                 ,bullets: _U.list([])};
   var update = F2(function (_p48,_p47) {
      var _p49 = _p48;
      var _p55 = _p49.pauseKey;
      var _p54 = _p49;
      var _p53 = _p49.delta;
      var _p50 = _p47;
      var _p52 = _p50;
      var _p51 = _p52.state;
      switch (_p51.ctor)
      {case "Start": return _U.update(_p52,{asteroids: randomAsteroids(timeSeed(_p53)),state: Pause});
         case "Over": return _p55 ? newGame : _p52;
         case "Pause": return _p55 ? _U.update(_p52,{state: Play}) : _p52;
         default: return A2(addBulletIfNeeded,_p54,A2(updatePlayer,_p54,A2(updateBullets,_p53,A2(updateAsteroids,_p53,updateState(_p52)))));}
   });
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,addVelocities: addVelocities
                             ,updatePlayer: updatePlayer
                             ,newBullet: newBullet
                             ,addBulletIfNeeded: addBulletIfNeeded
                             ,near: near
                             ,playerHasCollided: playerHasCollided
                             ,updateState: updateState
                             ,rotateAsteroidCourse: rotateAsteroidCourse
                             ,fragmentAsteroid: fragmentAsteroid
                             ,objectShouldBeRemoved: objectShouldBeRemoved
                             ,fragmentShotAsteroids: fragmentShotAsteroids
                             ,updateAsteroids: updateAsteroids
                             ,updateBullets: updateBullets
                             ,update: update
                             ,renderBullets: renderBullets
                             ,renderAsteroid: renderAsteroid
                             ,renderThrust: renderThrust
